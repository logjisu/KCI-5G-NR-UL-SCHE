...
void
NrMacSchedulerUeInfoAG::UpdateDlPFMetric (const NrMacSchedulerNs3::FTResources &totAssigned,
                                              double timeWindow,
...
void
NrMacSchedulerUeInfoAG::UpdateUlPFMetric (const NrMacSchedulerNs3::FTResources &totAssigned,
                                              double timeWindow,
                                              const Ptr<const NrAmc> &amc)
{
  NS_LOG_FUNCTION (this);
...
void
NrMacSchedulerUeInfoAG::CalculatePotentialTPutDl (const NrMacSchedulerNs3::FTResources &assignableInIteration,
                                                    const Ptr<const NrAmc> &amc)
{
  NS_LOG_FUNCTION (this);
...
void
NrMacSchedulerUeInfoAG::CalculatePotentialTPutUl (const NrMacSchedulerNs3::FTResources &assignableInIteration,
                                                    const Ptr<const NrAmc> &amc)
{
  NS_LOG_FUNCTION (this);
